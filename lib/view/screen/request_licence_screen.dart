                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Icon(Icons.cake, color: Colors.green.shade700),
                            ...
                            Builder(builder: (_) {
                              final List docs = (controller.licenceTypes[0]
                                      ['required_documents'] as List?) ??
                                  [];
                              ...
                              if (docs.isEmpty) {
                                return Container(
                                  ...
                                  child: const Text(
                                      "لا توجد مستندات مطلوبة لهذا النوع."),
                                );
                              }
                              ...
                              return ListView.builder(
                                ...
                                itemBuilder: (context, i) {
                                  final picked = (controller.files.length > i)
                                      ? controller.files[i]
                                      : null;
                                  final displayedName = picked != null
